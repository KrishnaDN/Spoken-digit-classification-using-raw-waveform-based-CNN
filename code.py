...
from models.waveform_ConvNet import ConvNet
...
for epoch in range(N_epochs):
    ...
    for i in range(N_batches):
        ...
        input_batch,input_labels = create_batch(batch_list,global_length)
        inputs = torch.reshape(input_batch,[batch_size,1,global_length])
